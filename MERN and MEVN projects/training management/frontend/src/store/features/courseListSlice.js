...
export const fetchCourseList = createAsyncThunk('courseList/fetchAll', async (query) => {
    const params=query?`?page=${query.page||''}&itemsPerPage=${query.itemsPerPage||''}&title=${query.title||''}`:"";
    const {data}= await axInstance.get('/get-course-list'+params,{
      headers: {
