      ...
      <Routes>
        <Route path="/" element={<ProtectedRoutes/>}>
          ...
          <Route path="user" element={<Outlet />}>
            ...
            <Route path=":courseSlug/course-details" element={<CourseDetails />} />
            <Route path=":courseSlug/course-details/:lessonID" element={<Lesson />} />
          ...
          <Route path="admin" element={<AdminRoutes/>}>
            ...
            <Route path=":courseSlug/:lessonID/edit-lesson" element={<EditLesson/>} />
            <Route path="create-batch" element={<CreateBatch/>} />
            <Route path=":batchID/edit-batch" element={<EditBatch/>} />
          </Route>
          <Route path="trainer" element={<TrainerRoutes/>} >
            <Route path="courselist" element={<TrainerCourseList/>} />
            <Route path=":batchID/:courseID/assessment-list" element={<TrainerAssessmentList/>} />
            <Route path=":batchID/:courseID/create-assessment" element={<CreateEval/>} />
            <Route path=":evalID/edit-assessment" element={<EditEval/>} />
            <Route path=":evalID/assessment-details" element={<EvaluationTasks/>} />
            ...
            <Route path=":batchID/:courseID/performance" element={<TrainerPerformance/>}/>
          </Route>
          <Route path="trainee" element={<TraineeRoutes/>} >
            <Route path=":batchID/:courseID/assessment-list" element={<TraineeAssessmentList/>} />
            <Route path=":evalID/assessment-details" element={<EvaluationTasks/>} />
          </Route>
        </Route>
