...
function TrainerAssessmentList() {
  ...
  return (
    ...
    <div className='text-center mb-4'>
      <Link to={`/trainer/${batchID}/${courseID}/create-assessment`} className="btn btn--deep-blue rounded-pill py-2 px-4 fs-5"> Add Assessment</Link>
    </div>
...
export default withHoc(`Course Assessments`,TrainerAssessmentList)