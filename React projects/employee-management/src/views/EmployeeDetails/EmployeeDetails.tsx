...
const EmployeeDetails = () => {
  ...
  return (
    <section>
      ...
      {!error && employee && (
        <div className={`card ${styles["emp-detail"]}`}>
          <div className={styles["emp-detail__options"]}>
            <Link
              to={`/employee/${employee.id}/edit`}
              className="btn btn--dark rounded-circle pt-2 pb-2"
              state={{ employee }}
            >
              <i className="fa fa-pencil"></i>
            </Link>
            <button
              className="btn btn--danger rounded-circle pt-2 pb-2"
              onClick={toggleModal}
            >
          ...
          <header className={styles["emp-detail__header"]}>
            <img
              src={logo}
              alt="Logo"
              className={styles["emp-detail__header__photo"]}
            />
            <h1>
          ...
          <div className={styles["emp-detail__body"]}>
            <div className={styles["emp-detail__body__info"]}>
              <h2 className={styles["emp-detail__body__info__heading"]}>
                Personal info
              </h2>
